...
namespace AccountingSystem.Views
{
    ...
    public partial class WeeklyLedgerView : Page
    {
        private int Id;
        ...
        public WeeklyLedgerView()
        {

            InitializeComponent();
            LoanLedger data = new LoanLedger();
            WeeklyLedger.ItemsSource = data.GetDataIndividual(method, 0, 0);
            DataContext = data;
        }
        ...
        private void Previous_Click(object sender, RoutedEventArgs e)
        {
            ...
            WeeklyLedger.ItemsSource = data.GetDataIndividual(method, tempId, 0);
            DataContext = data;
        }
